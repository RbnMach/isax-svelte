...
| Name Icon | Bold | Broken | Bulk | Linear | Outline | Twotone |
| --------- | ---- | ------ | ---- | ------ | ------- | ------- |
| aave      | ![aave](src/lib/svg/bold/aave.svg) | ![aave](src/lib/svg/broken/aave.svg) | ![aave](src/lib/svg/bulk/aave.svg)|![aave](src/lib/svg/linear/aave.svg)|![aave](src/lib/svg/outline/aave.svg)|![aave](src/lib/svg/twotone/aave.svg)|
